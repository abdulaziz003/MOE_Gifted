        ...
        <div class="container">
          <div class="grid">
            ...
            <div class="grid-program-info">
              ...
              <div class="program-date">date</div>
              <div class="program-hours">Hours</div>
              <div>info</div>
              <div>info</div>
              <div>info</div>
            </div>
            <div class="grid-main">
              ...
              <div class="student-name">الطالب/${name}</div>
              <div class="school-name">مدرسته / ثانوية الأمير فيصل</div>
              <div class="end-content">قم اتم البرنامج الاثرائي الموضحة بياناته أعلاه متمنين له مزيداً من التقدم والنجاح</div>
            </div>
            <div class="sign">
              <div class="manger">
